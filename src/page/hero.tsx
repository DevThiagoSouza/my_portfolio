    ...
    <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
      <Flex p={8} flex={1} align={'center'} justify={'center'}>
        <Stack spacing={6} w={'full'} maxW={'lg'}>
         ...
         Through this portfolio I will show a little about myself and my experiences
          </Text>
          ...
          <Stack direction="row" gap="1em" >
            ...
            <Icon as={AiFillLinkedin } boxSize="2em" _hover={{marginTop: "-0.8em" , transition : "0.8s"}}></Icon>
            </Link>
            <Link href='https://github.com/DevThiagoSouza?tab=repositories'>
            <Icon as={AiFillGithub } boxSize="2em" _hover={{marginTop: "-0.8em" , transition : "0.8s"}}></Icon>
            </Link>
            <Link href=''>
            <Icon as={AiFillFacebook } boxSize="2em" _hover={{marginTop: "-0.8em" , transition : "0.8s"}}></Icon>
            </Link>
            <Link href=''>
            <Icon as={AiFillInstagram } boxSize="2em" _hover={{marginTop: "-0.8em" , transition : "0.8s"}}></Icon>
            </Link>
